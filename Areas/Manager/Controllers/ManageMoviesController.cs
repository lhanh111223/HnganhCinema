...
using HnganhCinema.Areas.Manager.Models.ViewModels.MovieViewModels;
using System.Drawing;

namespace HnganhCinema.Areas.Manager.Controllers
{
    [Area("Manager")]
    [Route("Manager/ManageMovies/[action]/{id?}")]
    public class ManageMoviesController : Controller
    {
        ...
        public ManageMoviesController(CinemaDbContext context, RoleManager<IdentityRole> roleManager, AuthenticateHelper auth, UserManager<AppUser> userManager)
        {
            _context = context;
        ...
        // GET: Manager/ManageMovies/Details/5
        ...
        // GET: Manager/ManageMovies/Create
        ...
        // POST: Manager/ManageMovies/Create
        ...
        // GET: /Manager/ManageMovies/Edit/5 
        ...
        // POST: Manager/ManageMovies/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: Manager/ManageMovies/Delete/5
        ...
        // POST: Manager/ManageMovies/Delete/5
